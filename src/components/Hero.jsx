...
// const Hero = () => {
//   return (
//     <section className="min-h-[60vh] sm:min-h-[70vh] bg-black relative overflow-hidden flex items-center">
...
//           {/* Original SVG content remains the same */}
//           <svg
...
//       <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative py-6 sm:py-8 lg:py-0">
...
//
//             <motion.p
//               className="text-sm sm:text-base md:text-lg text-gray-300 mb-6 sm:mb-8 max-w-2xl"
//               initial={{ opacity: 0, y: 20 }}
//               animate={{ opacity: 1, y: 0 }}
...
//                 className="inline-block bg-white text-black px-6 sm:px-8 py-3 sm:py-4 rounded-full
